      ...
      <div className="flex p-4 gap-4 h-[400px]">
        ...
        <div className="w-60 flex flex-col gap-3">
          <div className="bg-[#E3F0FF] p-4 rounded-lg">
            ...
            <a
              href="/auth/signup"
              className="w-full bg-primary hover:bg-primary-dark text-white py-2 rounded-md mb-2 text-sm font-medium transition-colors text-center block"
            >
              Join now
            </a>
            <a
              href="/auth/login"
              className="w-full bg-white text-primary py-2 rounded-md text-sm font-medium border border-shade-border hover:bg-shade transition-colors text-center block"
            >
              Log in
            </a>
          </div>
